...
DV.load = function (documentRep, options) {
  ...
  function hideBlocker() {
    document.getElementById("iframeBlocker").style.display = "none";
  }
  ...
  setTimeout(initializeBlocker, 500);

  window.addEventListener("orientationchange",toggleBlocker);
  window.addEventListener("resize",toggleBlocker);
  window.addEventListener("documentViewerRendered",initializeBlocker);
